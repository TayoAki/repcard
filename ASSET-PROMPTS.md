...
## 8. Store screenshot backdrops (`shot-frame-a/b.png`, 1024×1820)
...
> 4%-opacity grid, subtle edge vignette. Variant B: glow sweeps diagonally from
> lower-left with three oversized translucent trading-card outlines drifting at 6%
> opacity. Pure backdrop — no devices, no text.
